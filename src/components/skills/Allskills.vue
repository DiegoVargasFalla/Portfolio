<template>
    <div class="cont-frontend-skills">
        <div class="container-img-skills">
            <!-- <h3 class="subtitle-skills">Front-End</h3> -->
            <div class="container-only-img-skils">
                <icons-skills 
                v-for="(item, key) in listIcons"
                :key="key"
                :name="item.name"
                :path-img="item.path"
                ></icons-skills>
